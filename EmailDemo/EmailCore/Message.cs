...
namespace EmailCore
{
    public class Message
    {
        ...
        /// <param name="attachments"> The attachments of the email. </param>
        public Message(List<Addressee> recipients, string subject, string body, IFormFileCollection attachments)
        {
